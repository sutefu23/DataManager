...
public let ボルト等選択肢リスト: [選択ボルト等型] = [
    ...
    選択ボルト等型(図番: "3033A", 種類: "特皿", サイズ: "4", 長さ: "6"), //
    ...
    選択ボルト等型(図番: "6711F", 種類: "スリムヘッド", サイズ: "2", 長さ: "5"), //
    // ナベ
    ...
    選択ボルト等型(図番: "9200", 種類: "片ネジ", サイズ: "2", 長さ: "100"), //
    // 六角
    ...
    選択ボルト等型(図番: "9687", 種類: "スタッド", サイズ: "8", 長さ: "20"), //
    ...
    // 三角コーナー
    選択ボルト等型(図番: "2016", 種類: "三角コーナー", サイズ: "", 長さ: ""), //
    // 浮かしパイプ
