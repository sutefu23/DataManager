...
public struct DMBarCode {
    ...
    public init?(nw7aa text: String) {
        var characters: [BarCodeCharacter] = [NW7.start]
        for ch in text.uppercased() {
            guard var character = NW7.codeMap[ch] else { return nil }
            character.character = ch
            characters.append(character)
        }
        characters.append(NW7.stop)
...
struct NW7 {
    ...
    static var start: BarCodeCharacter { codeTable[16].barcode }
    static var stop: BarCodeCharacter { codeTable[16].barcode }
    static var codeMap: [Character: BarCodeCharacter] = {
       var map = [Character: BarCodeCharacter]()
        for data in codeTable {
            map[data.character] = data.barcode
    ...
    static let w: CGFloat = 2.25
    static let codeTable: [NW7] = [
        NW7( 0, pattern: 1,1,1,1,1,w,w, character: "0"),
        NW7( 1, pattern: 1,1,1,1,w,w,1, character: "1"),
        NW7( 2, pattern: 1,1,1,w,1,1,w, character: "2"),
        NW7( 3, pattern: w,w,1,1,1,1,1, character: "3"),
        NW7( 4, pattern: 1,1,w,1,1,w,1, character: "4"),
        NW7( 5, pattern: w,1,1,1,1,w,1, character: "5"),
        NW7( 6, pattern: 1,w,1,1,1,1,w, character: "6"),
        NW7( 7, pattern: 1,w,1,1,w,1,1, character: "7"),
        NW7( 8, pattern: 1,w,w,1,1,1,1, character: "8"),
        NW7( 9, pattern: w,1,1,w,1,1,1, character: "9"),
        NW7(10, pattern: 1,1,1,w,w,1,1, character: "-"),
        NW7(11, pattern: 1,1,w,w,1,1,1, character: "$"),
        NW7(12, pattern: w,1,1,1,w,1,w, character: ":"),
        NW7(13, pattern: w,1,w,1,1,1,w, character: "/"),
        NW7(14, pattern: w,1,w,1,w,1,1, character: "."),
        NW7(15, pattern: 1,1,w,1,w,1,w, character: "+"),
        NW7(16, pattern: 1,1,w,w,1,w,1, character: "A"),
        NW7(17, pattern: 1,w,1,w,1,1,w, character: "B"),
        NW7(18, pattern: 1,1,1,w,1,w,w, character: "C"),
        NW7(19, pattern: 1,1,1,w,w,w,1, character: "D"),
    ]
}
