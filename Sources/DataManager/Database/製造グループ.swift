...
public enum 製造グループ型: CaseIterable, Comparable {
    ...
    public var members: [工程型] {
        switch self {
            ...
            case .第1製造グループ:
                return [.レーザー, .照合検査, .フォーミング, .タレパン, .プレーナー, .レーザー（アクリル）, .印刷, .腐蝕, .版焼き, .腐蝕印刷, .エッチング, .ルーター, .タップ, .シート貼り]
            case .第2製造グループ:
                return [.加工, .仕上, .切文字, .オブジェ]
            case .第3製造グループ:
                return [.立ち上がり, .立ち上がり_溶接, .裏加工, .裏加工_溶接, .半田, .溶接, .レーザー溶接, .ボンド, .付属品準備]
            case .第4製造グループ:
                return [.研磨, .表面仕上, .マスキング, .中塗り, .プライマー, .塗装, .下処理, .乾燥炉, .拭き取り, .組立]
            case .第5製造グループ:
                return [.外注, .発送, .品質管理]
        }
    }
