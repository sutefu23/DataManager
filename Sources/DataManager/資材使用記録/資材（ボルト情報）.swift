...
public enum 選択ボルト等種類型: String, Hashable {
    ...
    case 三角コーナー, アングル, アジャスター, アイメタルジョイナー
...
public struct 選択ボルト等型 {
    ...
    public var 長さValue: Double? {
        guard let str = self.長さ else { return nil }
        return Double(str)
    }
...
public let ボルト等選択肢基本マップ: [図番型: 選択ボルト等型] = {
    var map: [図番型: 選択ボルト等型] = [:]
    for data in ボルト等選択肢基本リスト {
        map[data.図番] = data
    }
    return map
}()

public let ボルト等選択肢基本リスト: [選択ボルト等型] = [
    // FB
    ...
    選択ボルト等型(図番: "5143F", 種類: .ボルト, サイズ: "3", 長さ: "60"), //
    ...
    選択ボルト等型(図番: "329F", 種類: .ボルト, サイズ: "4"), //
    選択ボルト等型(図番: "330F", 種類: .ボルト, サイズ: "5"), //
    選択ボルト等型(図番: "331F", 種類: .ボルト, サイズ: "6"), //
    選択ボルト等型(図番: "332F", 種類: .ボルト, サイズ: "8"), //
    選択ボルト等型(図番: "333F", 種類: .ボルト, サイズ: "3/8"), //
    選択ボルト等型(図番: "334", 種類: .ボルト, サイズ: "10"), //
    選択ボルト等型(図番: "335F", 種類: .ボルト, サイズ: "12"), //
    ...
    // 真鍮ボルト
    選択ボルト等型(図番: "3240", 種類: .真鍮ボルト, サイズ: "6", 長さ: "45"), //
    // ナット
    ...
    // 鬼目ナット
    選択ボルト等型(図番: "756", 種類: .鬼目ナット, サイズ: "8", 長さ: "20.5"), //
    // インサートナット
    選択ボルト等型(図番: "9920", 種類: .インサートナット, サイズ: "2"), //
    選択ボルト等型(図番: "9921", 種類: .インサートナット, サイズ: "3"), //
    // ワッシャー
    ...
    選択ボルト等型(図番: "9619", 種類: .皿, サイズ: "3", 長さ: "4"), //
    ...
    選択ボルト等型(図番: "2724", 種類: .皿, サイズ: "4", 長さ: "50"), //
    // 特皿
    ...
    選択ボルト等型(図番: "504", 種類: .特皿, サイズ: "4", 長さ: "30"), //
    ...
    選択ボルト等型(図番: "997082", 種類: .トラス, サイズ: "4", 長さ: "30"), //
    ...
    選択ボルト等型(図番: "88368", 種類: .スリムヘッド, サイズ: "2", 長さ: "6"), //
    ...
    選択ボルト等型(図番: "3288", 種類: .ナベ, サイズ: "4", 長さ: "15"), //
    ...
    選択ボルト等型(図番: "3288", 種類: .なべ, サイズ: "4", 長さ: "15"), //
    // テクスナベ
    ...
    // アジャスター
    選択ボルト等型(図番: "997267", 種類: .アジャスター, サイズ: ""), //
    // アイメタルジョイナー
    選択ボルト等型(図番: "881451", 種類: .アイメタルジョイナー, サイズ: ""), //
    // 外注
    ...
    // 真鍮釘
    選択ボルト等型(図番: "7651", 種類: .真鍮釘, サイズ: "1.6", 長さ: "22"), //
    選択ボルト等型(図番: "7322", 種類: .真鍮釘, サイズ: "1.8", 長さ: "22"), //
    // ステンレス釘
    選択ボルト等型(図番: "7650", 種類: .ステンレス釘, サイズ: "1.6", 長さ: "22"), //
...
public let ボルト等選択肢リスト: [選択ボルト等型] = ボルト等選択肢基本リスト + makeパイプリスト(種類: .浮かしパイプ) + makeパイプリスト(種類: .配線パイプ) + makeパイプリスト(種類: .電源用パイプ) + makeパイプリスト(種類: .丸パイプ)
